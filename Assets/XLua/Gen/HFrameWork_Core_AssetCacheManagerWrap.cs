    ...
    public class HFrameWorkCoreAssetCacheManagerWrap 
    {
        ...
        static int _m_LoadLuaAsync(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Action<System.Collections.Generic.IList<UnityEngine.TextAsset>>>(L, 4)) 
                {
                    ...
                    System.Action<System.Collections.Generic.IList<UnityEngine.TextAsset>> _onComplete = translator.GetDelegate<System.Action<System.Collections.Generic.IList<UnityEngine.TextAsset>>>(L, 4);
                        ...
                        System.Threading.Tasks.Task gen_ret = gen_to_be_invoked.LoadLuaAsync( _Label, _groupName, _onComplete );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _groupName = LuaAPI.lua_tostring(L, 3);
                        ...
                        System.Threading.Tasks.Task gen_ret = gen_to_be_invoked.LoadLuaAsync( _Label, _groupName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _Label = LuaAPI.lua_tostring(L, 2);
                        ...
                        System.Threading.Tasks.Task gen_ret = gen_to_be_invoked.LoadLuaAsync( _Label );
                        translator.Push(L, gen_ret);
