...
namespace XLua
{
    public static partial class CopyByValue
    {
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out UnityEngine.Playables.Playable val)
		{
		    val = new UnityEngine.Playables.Playable();
            int top = LuaAPI.lua_gettop(L);
			
		}
		
        public static bool Pack(IntPtr buff, int offset, UnityEngine.Playables.Playable field)
        {
            
            return true;
        }
        public static bool UnPack(IntPtr buff, int offset, out UnityEngine.Playables.Playable field)
        {
            field = default(UnityEngine.Playables.Playable);
