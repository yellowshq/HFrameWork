...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEnginePlayablesPlayable
        {
            static IniterAdderUnityEnginePlayablesPlayable()
            {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<UnityEngine.Playables.Playable>(translator.PushUnityEnginePlayablesPlayable, translator.Get, translator.UpdateUnityEnginePlayablesPlayable);
				translator.RegisterPushAndGetAndUpdate<UnityEngine.Playables.DirectorWrapMode>(translator.PushUnityEnginePlayablesDirectorWrapMode, translator.Get, translator.UpdateUnityEnginePlayablesDirectorWrapMode);
				translator.RegisterPushAndGetAndUpdate<UnityEngine.Playables.DirectorUpdateMode>(translator.PushUnityEnginePlayablesDirectorUpdateMode, translator.Get, translator.UpdateUnityEnginePlayablesDirectorUpdateMode);
				...
				translator.RegisterCaster<HFrameWork.Core.ProtoMap>(translator.Get);
			}
        }
        
        static IniterAdderUnityEnginePlayablesPlayable s_IniterAdderUnityEnginePlayablesPlayable_dumb_obj = new IniterAdderUnityEnginePlayablesPlayable();
        static IniterAdderUnityEnginePlayablesPlayable IniterAdderUnityEnginePlayablesPlayable_dumb_obj {get{return s_IniterAdderUnityEnginePlayablesPlayable_dumb_obj;}}
        
        
        int UnityEnginePlayablesPlayable_TypeID = -1;
        public void PushUnityEnginePlayablesPlayable(RealStatePtr L, UnityEngine.Playables.Playable val)
        {
            if (UnityEnginePlayablesPlayable_TypeID == -1)
            {
			    bool is_first;
                UnityEnginePlayablesPlayable_TypeID = getTypeId(L, typeof(UnityEngine.Playables.Playable), out is_first);
				
            }
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 0, UnityEnginePlayablesPlayable_TypeID);
            if (!CopyByValue.Pack(buff, 0, val))
            {
                throw new Exception("pack fail fail for UnityEngine.Playables.Playable ,value="+val);
            }
			
        }
		
        public void Get(RealStatePtr L, int index, out UnityEngine.Playables.Playable val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UnityEnginePlayablesPlayable_TypeID)
				{
				    throw new Exception("invalid userdata for UnityEngine.Playables.Playable");
				}
				
                IntPtr buff = LuaAPI.lua_touserdata(L, index);if (!CopyByValue.UnPack(buff, 0, out val))
                {
                    throw new Exception("unpack fail for UnityEngine.Playables.Playable");
                }
            }
            ...
            {
                val = (UnityEngine.Playables.Playable)objectCasters.GetCaster(typeof(UnityEngine.Playables.Playable))(L, index, null);
            }
        }
		
        public void UpdateUnityEnginePlayablesPlayable(RealStatePtr L, int index, UnityEngine.Playables.Playable val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  val))
                {
                    throw new Exception("pack fail for UnityEngine.Playables.Playable ,value="+val);
                }
            }
        ...
        int UnityEnginePlayablesDirectorWrapMode_TypeID = -1;
		int UnityEnginePlayablesDirectorWrapMode_EnumRef = -1;
        
        public void PushUnityEnginePlayablesDirectorWrapMode(RealStatePtr L, UnityEngine.Playables.DirectorWrapMode val)
        {
            if (UnityEnginePlayablesDirectorWrapMode_TypeID == -1)
            {
			    bool is_first;
                UnityEnginePlayablesDirectorWrapMode_TypeID = getTypeId(L, typeof(UnityEngine.Playables.DirectorWrapMode), out is_first);
				
				if (UnityEnginePlayablesDirectorWrapMode_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UnityEngine.Playables.DirectorWrapMode));
				    UnityEnginePlayablesDirectorWrapMode_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UnityEnginePlayablesDirectorWrapMode_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UnityEnginePlayablesDirectorWrapMode_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UnityEngine.Playables.DirectorWrapMode ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UnityEnginePlayablesDirectorWrapMode_EnumRef);
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Playables.DirectorWrapMode val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UnityEnginePlayablesDirectorWrapMode_TypeID)
				{
				    throw new Exception("invalid userdata for UnityEngine.Playables.DirectorWrapMode");
				}
                ...
                {
                    throw new Exception("unpack fail for UnityEngine.Playables.DirectorWrapMode");
                }
				val = (UnityEngine.Playables.DirectorWrapMode)e;
                
            }
            else
            {
                val = (UnityEngine.Playables.DirectorWrapMode)objectCasters.GetCaster(typeof(UnityEngine.Playables.DirectorWrapMode))(L, index, null);
            }
        }
		
        public void UpdateUnityEnginePlayablesDirectorWrapMode(RealStatePtr L, int index, UnityEngine.Playables.DirectorWrapMode val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UnityEngine.Playables.DirectorWrapMode ,value="+val);
                }
            }
        ...
        int UnityEnginePlayablesDirectorUpdateMode_TypeID = -1;
		int UnityEnginePlayablesDirectorUpdateMode_EnumRef = -1;
        
        public void PushUnityEnginePlayablesDirectorUpdateMode(RealStatePtr L, UnityEngine.Playables.DirectorUpdateMode val)
        {
            if (UnityEnginePlayablesDirectorUpdateMode_TypeID == -1)
            {
			    bool is_first;
                UnityEnginePlayablesDirectorUpdateMode_TypeID = getTypeId(L, typeof(UnityEngine.Playables.DirectorUpdateMode), out is_first);
				
				if (UnityEnginePlayablesDirectorUpdateMode_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(UnityEngine.Playables.DirectorUpdateMode));
				    UnityEnginePlayablesDirectorUpdateMode_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, UnityEnginePlayablesDirectorUpdateMode_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, UnityEnginePlayablesDirectorUpdateMode_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for UnityEngine.Playables.DirectorUpdateMode ,value="+val);
            }
			
			LuaAPI.lua_getref(L, UnityEnginePlayablesDirectorUpdateMode_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Playables.DirectorUpdateMode val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != UnityEnginePlayablesDirectorUpdateMode_TypeID)
				{
				    throw new Exception("invalid userdata for UnityEngine.Playables.DirectorUpdateMode");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for UnityEngine.Playables.DirectorUpdateMode");
                }
				val = (UnityEngine.Playables.DirectorUpdateMode)e;
                
            }
            else
            {
                val = (UnityEngine.Playables.DirectorUpdateMode)objectCasters.GetCaster(typeof(UnityEngine.Playables.DirectorUpdateMode))(L, index, null);
            }
        }
		
        public void UpdateUnityEnginePlayablesDirectorUpdateMode(RealStatePtr L, int index, UnityEngine.Playables.DirectorUpdateMode val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for UnityEngine.Playables.DirectorUpdateMode ,value="+val);
                }
            }
		...
		public void Get(RealStatePtr L, int index, out HFrameWork.Core.ProtoMap val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (HFrameWork.Core.ProtoMap)FastGetCSObj(L, index);
            }
			else if (type == LuaTypes.LUA_TTABLE)
			{
			    val = new HFrameWork.Core.ProtoMap();
				int top = LuaAPI.lua_gettop(L);
				
				if (Utils.LoadField(L, index, "msgID"))
				{
					Get(L, top + 1, out val.msgID);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "msgName"))
				{
					Get(L, top + 1, out val.msgName);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "pkgName"))
				{
					Get(L, top + 1, out val.pkgName);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "msgType"))
				{
					Get(L, top + 1, out val.msgType);
				}
				LuaAPI.lua_pop(L, 1);
            ...
            {
                throw new Exception("can not cast " + LuaAPI.lua_type(L, index) + " to " + typeof(HFrameWork.Core.ProtoMap));
            }
        }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			if (type == typeof(UnityEngine.Playables.Playable[]))
			{
			    UnityEngine.Playables.Playable[] array = obj as UnityEngine.Playables.Playable[];
				translator.PushUnityEnginePlayablesPlayable(L, array[index]);
				return true;
			}
			else if (type == typeof(UnityEngine.Playables.DirectorWrapMode[]))
			{
			    UnityEngine.Playables.DirectorWrapMode[] array = obj as UnityEngine.Playables.DirectorWrapMode[];
				translator.PushUnityEnginePlayablesDirectorWrapMode(L, array[index]);
				return true;
			}
			else if (type == typeof(UnityEngine.Playables.DirectorUpdateMode[]))
			{
			    UnityEngine.Playables.DirectorUpdateMode[] array = obj as UnityEngine.Playables.DirectorUpdateMode[];
				translator.PushUnityEnginePlayablesDirectorUpdateMode(L, array[index]);
				return true;
			}
		...
		internal static bool __tryArraySet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int array_idx, int obj_idx)
		{
			...
			else if (type == typeof(HFrameWork.Core.ProtoMap[]))
			{
			    HFrameWork.Core.ProtoMap[] array = obj as HFrameWork.Core.ProtoMap[];
				translator.Get(L, obj_idx, out array[array_idx]);
				return true;
			}
            return false;
