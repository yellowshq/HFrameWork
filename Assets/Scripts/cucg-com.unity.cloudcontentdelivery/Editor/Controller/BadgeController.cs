...
namespace CloudContentDelivery
{
    public class BadgeController
    {
            ...
            */
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(pagesPattern))
                {
                    ...
                    pba.totalBadgePages = pba.totalBadgeCounts / 10 + 1;
        ...
        {
            if (!Util.checkCosKey() || string.IsNullOrEmpty(pb.selectedBucketUuid) || string.IsNullOrEmpty(pba.selectedBadgeName))
            {
                return;
            }
