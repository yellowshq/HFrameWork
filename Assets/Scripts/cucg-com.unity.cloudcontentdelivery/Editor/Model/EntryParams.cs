...
namespace CloudContentDelivery
{
    ...
    public class EntryParams
    {
        ...
        public EntryParams(string path, string hash, long size, string contentType)
        {
            ...
            this.content_link = string.Format("cos:{0}/{1}", Parameters.projectGuid, hash);
        }
        ...
        public EntryParams(EntryInfo entryInfo)
        {
            ...
            this.content_link = string.Format("cos:{0}/{1}", Parameters.projectGuid, entryInfo.content_hash);
        }
    }
}